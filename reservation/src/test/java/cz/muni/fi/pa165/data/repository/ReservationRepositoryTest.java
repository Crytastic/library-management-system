...
class ReservationRepositoryTest {
    ...
    void setUp() {
        ...
        Reservation activeReservation = new Reservation("Reserved book", "User", activeReservationReservedFrom, activeReservationReservedTo);
        Reservation expiredReservation = new Reservation("Reserved book", "User", expiredReservationReservedFrom, expiredReservationReservedTo);
    ...
    void updateById_idFound_returnsOneOrMore() {
        int updatedCount = reservationRepository.updateById(activeReservationId, "New book name", null, null, null);
    ...
    void updateById_idNotFound_returnsZero() {
        ...
        int updatedCount = reservationRepository.updateById(activeReservationId + expiredReservationId, "New book name", null, null, null);
    ...
    void findAllActive_activeReservationExists_returnsListWithSizeOne() {
        ...
        assertThat(reservation.getBook()).isEqualTo("Reserved book");
        assertThat(reservation.getReservedBy()).isEqualTo("User");
