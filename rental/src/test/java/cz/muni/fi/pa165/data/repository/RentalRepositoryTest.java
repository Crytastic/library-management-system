...
class RentalRepositoryTest {
    ...
    void updateById_idFound_returnsOneOrMore() {
        int updatedCount = rentalRepository.updateById(rentalId, 1L, null, null, null, null, null, null, null);
        assertThat(updatedCount).isEqualTo(1);
    }

    @Test
    void updateById_idNotFound_returnZero() {
        int updatedCount = rentalRepository.updateById(rentalId - 1, 1L, null, null, null, null, null, null, null);
